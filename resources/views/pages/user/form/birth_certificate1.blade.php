                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="first_name" placeholder="FIRST NAME" oninput="this.value = this.value.toUpperCase()" required="required">
                                    </div>
                                    <div class="form-group">
                                        <label>MIDDLE NAME</label>
                                        <input class="form-control" name="middle_name" placeholder="MIDDLE NAME" oninput="this.value = this.value.toUpperCase()">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="date_birth" placeholder="YYYY-MM-DD">
                                    </div>
<div class="form-group">
