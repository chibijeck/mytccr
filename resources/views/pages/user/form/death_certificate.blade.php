                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="col-lg-12">
                                    ...
                                    {{ csrf_field() }}
                                    <input type="hidden" name="category" value="death_certificate">
                                    <input type="hidden" name="purpose" value="DEATH CERTIFICATE">
                                    ...
                                    function RadioGroup1_toggle(c)
                                    {
                                        switch(c.value)
                                        {
                                            case "YES": document.getElementById('hideme').style.visibility='visible';
                                            break;
                                            case "NO": document.getElementById('hideme').style.visibility='hidden';
                                            break;
                                            default: document.getElementById('hideme').style.visibility='hidden';
                                            break;
                                        }
                                       /*if (c.value == 'YES')
