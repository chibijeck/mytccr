                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    {{ csrf_field() }}
                                    <input type="hidden" name="category" value="correction_of_entry_in_the_day_andor_month_in_the_date_of_birth">
                                    <input type="hidden" name="purpose" value="CORRECTION OF ENTRY IN THE DAY AND/OR MONTH IN THE DATE OF BIRTH">
