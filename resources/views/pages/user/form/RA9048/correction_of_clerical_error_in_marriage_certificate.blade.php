                ...
                <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    {{ csrf_field() }}
                                    <input type="hidden" name="category" value="correction_of_clerical_error_in_marriage_certificate">
                                    <input type="hidden" name="purpose" value="CORRECTION OF CLERICAL ERROR IN MARRIAGE CERTIFICATE">
